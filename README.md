...
2. [Multi-table De-identification](docs/multi-table-deidentification.md)
3. [Group-level ID de-identification](docs/group-level-id-deidentification.md)
4. [Date and Time Shifting](docs/date-and-time-shifting.md)
5. [Free-text PHI Detection](docs/phi-detection.md)
6. [Logging and Auditing](docs/logging-and-auditing.md)
7. [Healthcare Schema Support](docs/healthcare-schema-support.md)
8. [Custom Transformers Plugins](docs/custom-transformers-plugins.md)
